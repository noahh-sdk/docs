...
If you have an issue running that command for whatever reason ([let us know!](https://github.com/noahh-sdk/cli/issues)), you can build your mod the same way using these commands:
```bash
# Configure CMake
cmake -B build
...
If you [created a profile in CLI](/getting-started/noahh-cli), then the mod should be automatically copied over to your mods folder, if not, then the built `your.mod.noahh` file should be in your build folder.
