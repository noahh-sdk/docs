...
The build should end with a message saying `Build finished` and (assuming you ran `noahh config setup` before) the mod should now be installed to Geometry Dash. In order to make all the IDE features work correctly, reload CMake now, this run should end successfully with a message saying `[Finished]` at the end: 
