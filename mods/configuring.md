...
The name of the mod's developer, displayed on the Installed tab. Should be a single name, like "NoahBajsToa" or "Alk". If the mod has multiple developers, this should be a team name like "Noahh Team".
