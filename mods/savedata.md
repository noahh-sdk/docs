...
You can save any type of value as long as it implements `json::Serialize` (see the [STL container implementations](https://github.com/noahh-sdk/json/blob/main/include/json/stl_serialize.hpp) for an example).
