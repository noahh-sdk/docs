...
1. Make sure you have the [**latest** CLI](/getting-started/noahh-cli) set up.
...
4. Login to the index using the **CLI**: `noahh index login`. This will prompt you to login using your GitHub account.
5. Run `noahh index mods create`
6. Provide a **direct download link** to the .noahh file (for example `https://github.com/HJfod/BetterEdit/releases/download/v6.3.3/hjfod.betteredit.noahh`)
