...
Once your awesome mod is finished, it's time to publish it for all the world to see! Noahh comes with an in-game "Download" section where users can download mods from, which gets its content from [the Noahh Index](https://api.noahh-sdk.org/v1/mods).
...
1. Download the latest release of the [CLI](https://github.com/noahh-sdk/cli/releases/latest). You can also use [Scoop](https://scoop.sh/), or a [brew cask on macOS](https://github.com/noahh-sdk/cli/releases/latest). Also make sure the CLI is added to your **path**
...
3. Login to the index using the **CLI**: `noahh index login`. This will prompt you to login using your GitHub account.
4. `noahh index mods update`
5. Provide a **direct download link** to the .noahh file (for example `https://github.com/HJfod/BetterEdit/releases/download/v6.3.3/hjfod.betteredit.noahh`)
...
To release an update, use `noahh index mods update`. You will have to be already logged in with the index to use this command.
