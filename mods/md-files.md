...
> :information_source: As of [CLI v3.5.0](https://github.com/noahh-sdk/cli/releases/tag/v3.5.0), if a `README.md` is present but not an `about.md`, the readme will be used as the mod description. \
...
A markdown file that contains a changelog for your mod. Noahh uses this file to show release notes for the mod.
