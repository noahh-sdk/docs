...
Here are a couple of common errors people have experienced using Noahh in VS Code and how to fix them.

## Include file `<Noahh/Noahh.hpp>` not found

![Image showing VS Code C++ extension unable to find Noahh headers](/assets/include_path_error.png)
...
First, once you have the CMake Tools extension installed, open up your Noahh mod, press **F1** and run `CMake: Select a Kit`. This will bring up a list of installed compilers on your machine.
...
Now if you run `CMake: Configure`, assuming you have Noahh properly installed, the include errors should go away.
