...
These are the guidelines for how mods are allowed to the [mods index](https://noahh-sdk.org/mods). **All mods on the index are required to follow these rules.**
 ...
 * The mod **installs other mods from outside the Noahh index**. You are not allowed to unsafely run any arbitary code downloaded off the internet. An exception is installing additional paid features as a runtime library; do note that for the purposes of verification, the code for all of those paid features must be included, including the code used to load them.
