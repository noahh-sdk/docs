...
Some mods may want to **extend Noahh's own UI**, for example to add custom features to their own mod's page. This is allowed, however on the following conditions:
...
These rules are in place because the Noahh UI is a highly volatile place that **may change at any time**, and any mod causing the Noahh UI itself to crash would make it impossible to disable without safe mode.
