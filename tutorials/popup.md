...
> You might wonder about how to use other colors than the ones listed; there are currently no plans in Noahh to add that, but one could easily make a mod that adds support for arbitary color tags.
