...
Getting your mod on the mods repo and available to all Noahh users is as simple as sending the mod's **source code** to some Noahh lead developer, usually by just [opening a pull request on the mods repo](https://github.com/noahh-sdk/mods/pulls). If your mod is closed source, send it to HJfod for Windows mods (HJfod#1795) or Alk for Mac mods (alk1m123#3076). We will verify that your mod adheres to [Noahh guidelines](#guidelines) and is good to go, and will put it up on the mods index :)
