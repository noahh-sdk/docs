...
Luckily, Noahh come to the rescue with the `noahh::utils::web` namespace, which contains functions resembling a familiar web API: **fetch**. Noahh has two types of web requests: **synchronous** and **asynchronous**.
