...
The old web APIs were deprecated as of **v3.0.0-alpha.1**, you can still find them on older versions of Noahh. They contain functions resembling a familiar web API: **fetch**. Noahh has two types of web requests: **synchronous** and **asynchronous**.
