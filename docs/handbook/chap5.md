...
You can find the **class name** of a given layer using the [DevTools](https://github.com/hjfod/devtools) mod in Noahh. Traditionally, the most common mod for inspecting the scene was [CocosExplorer](https://github.com/matcool/CocosExplorer), however as it is a traditional mod, it does not work with Noahh.
...
One thing you will notice in DevTools is that many of the nodes have **string IDs**; this is a **Noahh-specific addition** meant to make modding simpler. You can read more about string IDs [in its dedicated article](/docs/tutorials/nodetree.md).
