...
?> If you don't want to bring Noahh namespaces into scope, you can just use `using namespace cocos2d` instead.
...
To try the mod out, [create a new mod using `noahh new`](/docs/info/creating.md), and then replace the code in `src/main.cpp` with the above. After building the mod, open up GD and you should see this:
