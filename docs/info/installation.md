...
1. Install [Noahh CLI](https://github.com/noahh-sdk/cli/releases/latest) [(Instructons)](/docs/info/installcli.md)
  ...
  * Unzip the download file somewhere, and [add the directory with noahh.exe to your user's PATH variable](/docs/info/installcli.md?id=adding-cli-to-path-on-windows). You may need to restart your command line after adding the directory to your path.
