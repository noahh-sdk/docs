...
Hello everyone! This is **an introduction to GD Modding (using Noahh)**, a handbook that covers all of the essentials of GD Modding. For this handbook, you will need to have [**Noahh** installed](/docs/info/installation.md). Please note that while this is also written as a tutorial for beginners, it also does **contain much useful information about Noahh-specific things for experienced modders who come from a gd.h/cocos-headers background, so it is recommended you read it through anyway**.
