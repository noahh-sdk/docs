# An Introduction to GD Modding (using Noahh)

Hello everyone! This is **an introduction to GD Modding (using Noahh)**, a handbook that covers all of the essentials of GD Modding. To follow along with this handbook, you will need to have [**Noahh** installed](/info/installation.md). This handbook is written as a **tutorial for beginners**, though even if you are an experienced GD modder already, getting a fresh-up on the basics can never do harm. Even if for some reason you don't use Noahh, this handbook still contains **general information about modding and GD modding specifically**, however all practical code examples and the code project we will build later will use Noahh.
 ...
 * **Volume 3**: Noahh, working with other mods, and publishing your mod
...
Many things in this handbook are referred to as "traditional modding". This means mods made and modding methods used before Noahh was released; Noahh is quite different from all modding libraries that came before it, and as such it differs from them in many ways. The ways things were traditionally done are still included in this tutorial however, both as a historical curiosity and to make this handbook more appealing to Noahh haters.
