...
You can find the **class name** of a given layer using the [DevTools](https://github.com/noahh-sdk/devtools) mod in Noahh. To see how it works, install the **DevTools** mod in-game through the **Download** tab in Noahh and then press **F11** to activate it:
