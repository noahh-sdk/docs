...
To try the mod out, [create a new mod using `noahh new`](/noahh/creating), and then replace the code in `src/main.cpp` with the above. After building the mod, open up GD and you should see this:
