...
These are instructions for building the [Noahh Loader](https://github.com/noahh-sdk/loader). For building your own mods, see `A_PAGE_WE_HAVENT_MADE_YET_PLEASE_ADD_WHEN_ITS_MADE`.
