...
You can easily create a mod using the [Noahh CLI](/noahh/installcli), by simply running this command in a terminal / command prompt and answering the prompts that follow.
```
noahh new
```
...
Make sure the `NOAHH_SDK` enviroment variable works.
