...
These are instructions for building the [Noahh Loader](https://github.com/noahh-sdk/noahh). For building your own mods, see [Getting Started](/starting).
...
4. `git clone https://github.com/noahh-sdk/noahh --recursive`
