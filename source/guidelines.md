...
If Noahh has a solution to a problem, use that and do **not** create your own solution to it. If you want to add custom keybinds to your mod, use the Noahh API. If you feel the solution Noahh provides is insufficient for your needs, please [let us know](/contributing) and we'll look into expanding it.
