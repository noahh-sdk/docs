...
Haven't found what you need inside the api? Do you want to modify the behaviour of a Geometry Dash class because it is bad? Do you want implement new features? Look no further! Noahh has the tool for you!
...
There is a class inside the `noahh::modifier` namespace called `field`. This class allows you to introduce members into the classes you modify. Here is an example:
